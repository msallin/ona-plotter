...
public class ChartLayerControllerTests
{
    ...
    private sealed class DisplayFakeSettings : OnaPlotter.Services.Settings.IMapDisplaySettings
    {
        ...
        public bool DistanceRingsEnabled => false;
        public double DistanceRingsBaseNm => 0.5;
        public int DistanceRingsCount => 4;
        ...
        public Task SetDistanceRingsEnabledAsync(bool v) => Task.CompletedTask;
        public Task SetDistanceRingsBaseNmAsync(double v) => Task.CompletedTask;
        public Task SetDistanceRingsCountAsync(int v) => Task.CompletedTask;
